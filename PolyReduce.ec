(* Matthias Meijer, Pierre-Yves Strub and Andreas Huelsing's            *)
(* PolyReduce theory which will at some point be included into EasyCrypt*)
(* credited as contributors to EasyCrypt                                 *)
(* https://github.com/MM45/Saber-Formal-Verification-EasyCrypt/blob/main/saberpke/PolyReduce.ec *)
